...
/////////////////////////////////////////////////////////
function cargarAsync(url, funcionRetorno) {
	if (miXHR) {
		...
		// En cada cambio de estado(readyState) se llamará a la función indicada en el parámetro funcionRetorno
		miXHR.onreadystatechange = eval(funcionRetorno);
